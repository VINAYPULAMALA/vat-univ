...
const CommercialCookery: React.FC = () => {
  const courseInfo = {
    code: "SIT30821 ",
  ...
  const courseDetails = [
    {
      label: "AQF Level 3",
      value: "Qualification Code SIT30821",
    },
    {
        ...
        <>
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-md">
            ...
            <p className="text-gray-700">
              ...
              <br />
              <Link
                to="https://training.gov.au/Training/Details/SIT30821"
                target="_blank"
                className="text-blue-600 hover:underline word-break"
              >
                https://training.gov.au/Training/Details/SIT30821 </Link>
            </p>
          </div>
        </>
      ),
  ...
  const units: Unit[] = [
    ...
    {
      no: 21,
      unitCode: "SITHCCC040* (Group A)",
      unitTitle: " Prepare and Serve Cheese",
      type: "E",
    },
    {
      no: 22,
      unitCode: "SITHCCC039* (Group A)",
      unitTitle: " Produce pates and terrines",
      type: "E",
    },
    {
      no: 23,
      unitCode: "BSBSUS211 * (Group C)",
      unitTitle: " Participate in sustainable work practice",
      type: "E",
    },
    {
      no: 24,
      unitCode: "SITXINV007 *(Group C)",
      unitTitle: "Purchase Goods",
      type: "E",
    },
     {
      no: 25,
      unitCode: "SITHCCC026 (Group A)",
  ...
  const courseRequirementSteps: Step[] = [
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-1">
          <li>Students are required to complete a minimum of 48 food service periods of 4 hours each in a commercial kitchen to meet the qualification requirements of SIT30821 Certificate III in Commercial Cookery.</li>
  ...
  return (
    <>
      <PagesHeader
        title="SIT30821 "
        subtitle=" Certificate III in Commercial Cookery"
...
export default CommercialCookery;
